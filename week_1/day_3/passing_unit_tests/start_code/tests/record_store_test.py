...
class TestRecordStore(unittest.TestCase):
    ...
    def setUp(self): #setting up test data    self refers to class of object
        self.record1 = {
    ...
    def test_get_name(self):                          #unit test is always run in relation to self
        result = get_name(self.record_store)
        self.assertEqual("CodeClan Records", result) #makes an assertion result is equal to code on records

    #@unittest.skip("delete this line to run the test") #this line skips the test
